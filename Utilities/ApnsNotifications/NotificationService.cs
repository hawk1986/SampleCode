...
namespace Utilities.ApnsNotifications
{
    public class NotificationService : IDisposable
    {
        ...
        private readonly List<NotificationConnection> notificationConnections = new List<NotificationConnection>();
        ...
        private readonly string P12FilePassword;
